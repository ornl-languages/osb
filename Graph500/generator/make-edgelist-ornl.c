...
int main(int argc, char **argv){
    ...
    printf("Generation time: %G\n", (double) ORB_seconds(t2, t1));
    ...
    fprintf(ofile, "%lld %lld\n", (long long) nvtx_scale, (long long) nedge);
    for(i = 0; i < nedge; i++){
        fprintf(ofile, "%lld %lld\n", (long long) IJ[i].v0, (long long) IJ[i].v1);
    }
    ORB_read(t3);
    printf("Output time: %G\n", (double) ORB_seconds(t3, t2));
    printf("Total time: %G\n", (double) ORB_seconds(t3, t1));
    printf("Output edges: %lld\n", (long long) nedge);
    printf("Output vertices: %lld\n", (long long) nvtx_scale);
