...
rundir=debug_s20_1node_$PBS_JOBID
mkdir $rundir
cd $rundir
...
# mpirun   bazooka02 12  ../graph500_mpi_simple  20 16 >& mpt_simple_s20.p12
# mpirun   bazooka02 12  ../graph500_mpi_one_sided  20 16 >& mpt_mpi_s20.p12
 mpirun   bazooka02 12  ../graph500_shmem_one_sided  20 16 >& mpt_shmem_s20.p12
