...
#ifdef USE_OPENSHMEM
scatter_constant* init_scatter_constant(void* array, size_t array_size, size_t elt_size, void* constant, size_t nrequests_max, int dt);
#else
...
#ifdef USE_OPENSHMEM
scatter* init_scatter(void* array, size_t array_size, size_t elt_size, size_t nrequests_max, int dt);
#else
